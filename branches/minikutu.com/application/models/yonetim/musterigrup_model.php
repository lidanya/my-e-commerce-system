...
class musterigrup_model extends CI_Model
{
	...
	function musteri_grup_listele($page = 0)
	{
		...
		$sorgu_say = $this->db->get_where('roles', array('parent_id' => '1'));
		$config['per_page'] = $per_page;
		$config['total_rows'] = $sorgu_say->num_rows();
		$config['full_tag_open'] = 'Sayfa : ';
		$config['full_tag_close'] = '';
		$config['num_links'] = 4;
		$config['base_url'] = base_url() . 'yonetim/satis/musteri_grup/listele';
