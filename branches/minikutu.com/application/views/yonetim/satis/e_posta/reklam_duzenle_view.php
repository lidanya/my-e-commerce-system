...
<div class="box">
  ...
  <div class="content">
    ...
    <form action="<?php echo yonetim_url('satis/e_posta/reklam_duzenle/'. $id); ?>" method="post" enctype="multipart/form-data" id="form">
    <input type="hidden" name="reklam_id" value="<?php echo $id; ?>"/>
    <table class="form">
		<?php 
		if($reklam)
		{
        ...
        <tr>
          ...
          <td colspan="2"><input type="text" name="reklam_adi" value="<?php echo ($val->reklam_adi) ? $val->reklam_adi : $reklam->reklam_adi ;?>"   style="width:400px;" />
        ...
        <tr>
          ...
          <td colspan="2">
          	<input type="text" name="reklam_link" value="<?php echo ($val->reklam_link) ? $val->reklam_link : ($reklam->reklam_link) ? $reklam->reklam_link : base_url() ;?>"  style="width:400px;" />
        ...
        <tr>
          ...
          <td>
          	<textarea onkeyup="metni_yaz(this,'#metin')" name="reklam_metni" style="width:400px; height:120px;"><?php echo ($val->reklam_metni) ? $val->reklam_metni : $reklam->reklam_icerik ;?></textarea>
		  ...
		  <td style="text-align:center;"><p style="font-weight:bold:color:#000;margin:0px auto 5px; text-align:center;width:400px;">Reklam Metni Gönderilen E-Postada Aşağıdaki Gibi Görüntülenecektir:</p>
		  	<div id="metin" style="width:400px;margin:auto;height:45px;background-color:#f1f1f1;text-align:center;padding-top:15px;font-size:16px;color:#008fff;overflow:hidden;"><?php echo ($val->reklam_metni) ? $val->reklam_metni : nl2br($reklam->reklam_icerik); ?></div>
		  </td>
        </tr>
        ...
        <tr>
          ...
          <td colspan="2">
          	<?php
          		$durum = ($val->reklam_durum) ? $val->reklam_durum : $reklam->reklam_flag;
    ...
    <?php } else { ?>
    <tr>
    	<td colspan="3">Gösterilecek sonuç bulunamadı.</td>
	</tr>
    <?php } ?>
        </table>
    </form>
