...
<div class="box">
	...
	<div class="heading">
		...
		<div class="butons" style="float:right;margin-top:5px;">
			<a onclick="location = '<?php echo yonetim_url('uye_yonetimi/musteri_grup/ekle'); ?>'" class="buton"><span>Ekle</span></a>
			<a onclick="$('form').submit();" class="buton" style="margin-left:10px;"><span>Sil</span></a>
		</div>
	</div>
	<div class="content">
		<form action="<?php echo yonetim_url('uye_yonetimi/musteri_grup/sil'); ?>" method="post" enctype="multipart/form-data" id="form">
			<table class="list">
				<thead>
					<tr>
						<td width="1" style="text-align: center;"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);" /></td>
						<td class="left">Müşteri Grup Adı</td>
				...
				<?php } else { ?>
					<tr>
	            		<td class="center" colspan="3">Müşteri Grubu Bulunamadı</td>
					</tr>
				<?php } ?>
	        	</tbody>
			</table>
