	...
	<?php } else { ?>
			<!-- Hata -->
			 <div id="onay_mesaj">
			 	...
			 	<div class="clear"></div>
			 	<p class="onay_buton">
			 		<a href="javascript:history.back();" title="<?php echo lang('messages_button_back'); ?>" class="buton"><span><img src="<?php echo face_resim();?>btn_img_geri.png" alt="<?php echo lang('messages_button_back'); ?>" />&nbsp;<?php echo lang('messages_button_back'); ?></span></a>
					<a class="buton" style="margin-left:10px;" href="<?php echo face_site_url('site/index'); ?>" title="<?php echo lang('messages_button_back_home'); ?>" target="_top"><span><img src="<?php echo face_resim();?>btn_img_anasayfa.png" alt="<?php echo lang('messages_button_back_home'); ?>" />&nbsp;<?php echo lang('messages_button_back_home'); ?></span></a>
			 	</p>
			 </div>
			 <!-- Hata SON -->
	<?php } ?>
