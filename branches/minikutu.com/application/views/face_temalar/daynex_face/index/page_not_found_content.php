...
<div id="orta" class="sola">
	...
	<div class="clear"></div>
		<!-- Hata -->
		 <div id="onay_mesaj">
		 	<div class="onay_image sola"><img src="<?php echo face_resim();?>unlem.png" alt="<?php echo lang('messages_page_not_found_title'); ?>" title="<?php echo lang('messages_page_not_found_title'); ?>"></div>
		 	<div class="onay_aciklama sola" style="padding-top:40px;">
		 		<b><?php echo lang('messages_page_not_found_title'); ?></b>
		 		<br /><?php echo strtr(lang('messages_page_not_found_content'), array('{_contact_url_}' => face_site_url('site/iletisim'))); ?>
	 		</div>
		 	<div class="clear"></div>
		 	<p class="onay_buton">
				...
				<a class="butonum" style="margin-left:10px;" href="<?php echo face_site_url(); ?>" title="<?php echo lang('messages_button_back_home'); ?>">
					<span class="butsol"></span>
