 ...
 **/
 ...
 /*
	SQL Kodu
	O:8:"stdClass":1:{s:9:"3doosfull";O:8:"stdClass":5:{s:10:"merchantid";s:0:"";s:10:"terminalid";s:0:"";s:8:"storekey";s:0:"";s:8:"username";s:0:"";s:8:"password";s:0:"";}}
	Php Kodu
	$olustur->{'3doosfull'}->merchantid	= '';
	$olustur->{'3doosfull'}->terminalid	= '';
	$olustur->{'3doosfull'}->storekey	= '';
	$olustur->{'3doosfull'}->username	= '';
	$olustur->{'3doosfull'}->password	= '';
	echo serialize($olustur);
 */

class garanti_3doosfull
{
	public $ci;
	protected $banka = 'garanti';
	protected $ascii = '3doosfull';
	protected $banka_bilgi = false;

	/**
	 * garanti_oospay construct
	 *
	 * @return void
	 * @author E-Ticaret Sistemim
	 **/
	...
	{
		log_message('debug', 'garanti_3doosfull Library Yüklendi');
	...
	function form_gonder($gelen_veriler = null)
	{
		if(!is_null($gelen_veriler) AND $banka_bilgi = $this->banka_bilgi())
		{
			...
			$form .= form_hidden('secure3dsecuritylevel', '3D_OOS_FULL');
