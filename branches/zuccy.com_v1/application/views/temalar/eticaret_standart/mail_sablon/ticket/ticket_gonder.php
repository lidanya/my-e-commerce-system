...
?>
 <!--Başvuru Onayı -->
 <div style="margin-left:35px;font-weight:bold;font-size:14px !important;color:#ff6400 !important; !important;">
		Sn <b style="color:#008fff !important;font-size:18px !important;"><?php echo $ad; ?> <?php echo $soyad; ?></b> Bizi Tercih Ettiğiniz İçin Teşekkür Ederiz
  </div>
 <div style="width:480px;font-size:12px;margin:10px auto;">
 	<?php echo (!empty($ticket_row->ticket_kodu)) ? $ticket_row->ticket_kodu : $ticket_kodu;?>
 	kodlu ticketınız başarıyla alınmıştır.</div>

<div style="width:480px;margin:10px auto;font-size:12px;">Bildirimle alakalı yardıma ihtiyaç duyarsanız <a href="<?php echo site_url('site/iletisim'); ?>" target="_blank" style="color:<?php echo $_1cirenk; ?> !important;" target="_blank">yardım merkezimizden</a> bize ulaşabilirsiniz. <br />Sabır ve anlayışınız için teşekkür ederiz</div>
 <!--Başvuru Onayı SON-->
