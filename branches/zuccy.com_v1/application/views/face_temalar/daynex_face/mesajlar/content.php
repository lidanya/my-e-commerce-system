	...
	<div id="orta" class="sola">
		...
		<h1 id="sayfa_baslik"><?php echo lang('messages_static_page_messages_success_title'); ?></h1>
			...
			<!-- Onay -->
			 <div id="onay_mesaj">
			 	<div class="onay_image sola"><img src="<?php echo face_resim(); ?>okey.png" alt="<?php echo $baslik; ?>" title="<?php echo $baslik; ?>"></div>
			 	...
			 	<p class="onay_buton">
			 		...
			 		<?php } ?>
					<a class="butonum" style="margin-left:10px;" href="<?php echo face_site_url('site/index'); ?>">
						<span class="butsol"></span>
						<span class="butor"><img src="<?php echo face_resim(); ?>btn_img_anasayfa.png" alt="Anasayfaya Dön" /> <?php echo lang('messages_button_back_home'); ?></span>
						<span class="butsag"></span>
					</a>
			 	</p>
			 </div>
		...
		<h1 id="sayfa_baslik"><?php echo lang('messages_static_page_messages_error_title'); ?></h1>
			...
			<!-- Onay -->
			 <div id="onay_mesaj">
			 	<div class="onay_image sola"><img src="<?php echo face_resim(); ?>unlem.png" alt="Onay" title="<?php echo $baslik; ?>"></div>
			 	...
			 	<p class="onay_buton">
			 		...
			 		<a class="butonum" onclick="history.back();">
			 			<span class="butsol"></span>
			 			<span class="butor"><img src="<?php echo face_resim(); ?>btn_img_geri.png" alt="Geri Dön" /> <?php echo lang('messages_button_back'); ?></span>
			 			<span class="butsag"></span>
		 			</a>
			 		<?php } ?>
					<a class="butonum" style="margin-left:10px;" href="<?php echo face_site_url('site/index'); ?>">
