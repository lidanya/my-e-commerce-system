...
$this->load->view('yonetim/header_view');  
	...
	$slider_link = array(
		...
		'class' 	=> 'slider_link',
		'size'		=> '43',
		'value' 	=> ($val->slider_link) ? $val->slider_link:NULL
	);
	...
	$slider_sira = array(
		...
		'class' 	=> 'slider_sira',
		'size'		=> '43',
		'value' 	=> ($val->slider_sira) ? $val->slider_sira:NULL
	);
...
<div class="box">
  ...
  <div class="content">
    <form action="<?php echo yonetim_url('moduller/slider/ekle'); ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
		<tr>
			<td>
				Slider Resim<br />
				<span class="help">Slider eklemek için tıklayın.</span>
			</td>
				<?php
