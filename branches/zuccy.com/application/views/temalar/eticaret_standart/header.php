...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php echo $this->fonksiyonlar->get_language('code'); ?>">
	<head>
		...
		<script type="text/javascript">
			...
			function batch(){
				var url = "/yonetim/urunler/product_batch";
				var data = 'xaRwdQ42'; 
	...
	<body>
		<div id="Full" class="topmenubg">
			<div id="Top">
				...
				<div class="saga" style="margin-right: 150px; padding-top: 3px;">
				<span style="
					  color: #fff;
					  font-size: 14px;
					  ">$ <?php echo number_format(kur_oku("usd"),2); ?>
				</span>
				<span style="padding-left: 10px;
					  color: #fff;
					  font-size: 14px;
					  ">€ <?php echo number_format(kur_oku("eur"),2); ?>
				</span>
				</div>
			</div>
