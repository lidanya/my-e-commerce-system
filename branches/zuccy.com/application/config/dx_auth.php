...
$config['DX_website_name'] = 'eticaret.net';
$config['DX_webmaster_email'] = 'info@eticaret.net';
...
$config['DX_deny_uri'] 			 = '/tr/uyelik/yasak_bolge/';
$config['DX_login_uri'] 	 	 = '/tr/uyelik/giris/';
$config['DX_banned_uri'] 	 	 = '/tr/uyelik/cezali/';
$config['DX_activate_uri'] 		 = '/tr/uyelik/aktivasyon/';
$config['DX_reset_password_uri'] = '/tr/uye/aktivasyon/sifre/';
...
// URI Locations
$config['DX_logout_uri'] 		  = '/uyelik/cikis/';
$config['DX_register_uri'] 			= '/uye_ol/';
$config['DX_forgot_password_uri'] = '/uyelik/sifremi_unuttum/';
$config['DX_change_password_uri'] = '/uyelik/sifre_degistir/';
$config['DX_cancel_account_uri'] = '/uyelik/cancel_account/';
