 ...
 **/
 ...
 /*
	SQL Kodu
	O:8:"stdClass":1:{s:6:"3dhalf";O:8:"stdClass":5:{s:10:"merchantid";s:0:"";s:10:"terminalid";s:0:"";s:8:"storekey";s:0:"";s:8:"username";s:0:"";s:8:"password";s:0:"";}}
	Php Kodu
	$olustur->{'3dhalf'}->merchantid	= '';
	$olustur->{'3dhalf'}->terminalid	= '';
	$olustur->{'3dhalf'}->storekey		= '';
	$olustur->{'3dhalf'}->username		= '';
	$olustur->{'3dhalf'}->password		= '';
	echo serialize($olustur);
 */

class garanti_3dhalf
{
	public $ci;
	protected $banka = 'garanti';
	protected $ascii = '3dhalf';
	...
	{
		log_message('debug', 'garanti_3dhalf Library Yüklendi');
	...
	function form_gonder($gelen_veriler = null)
	{
		if(!is_null($gelen_veriler) AND $banka_bilgi = $this->banka_bilgi())
		{
			...
			$form .= form_hidden('secure3dsecuritylevel', '3D_HALF');
