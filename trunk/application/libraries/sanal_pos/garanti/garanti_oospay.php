 ...
 **/
 ...
 /*
	SQL Kodu
	O:8:"stdClass":1:{s:6:"oospay";O:8:"stdClass":5:{s:10:"merchantid";s:0:"";s:10:"terminalid";s:0:"";s:8:"storekey";s:0:"";s:8:"username";s:0:"";s:8:"password";s:0:"";}}
	Php Kodu
	$olustur->{'oospay'}->merchantid	= '';
	$olustur->{'oospay'}->terminalid	= '';
	$olustur->{'oospay'}->storekey		= '';
	$olustur->{'oospay'}->username		= '';
	$olustur->{'oospay'}->password		= '';
	echo serialize($olustur);
 */

class garanti_oospay
{
	public $ci;
