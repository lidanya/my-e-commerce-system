 ...
 **/
 ...
 /*
	SQL Kodu
	O:8:"stdClass":1:{s:9:"3dooshalf";O:8:"stdClass":5:{s:10:"merchantid";s:0:"";s:10:"terminalid";s:0:"";s:8:"storekey";s:0:"";s:8:"username";s:0:"";s:8:"password";s:0:"";}}
	Php Kodu
	$olustur->{'3dooshalf'}->merchantid	= '';
	$olustur->{'3dooshalf'}->terminalid	= '';
	$olustur->{'3dooshalf'}->storekey	= '';
	$olustur->{'3dooshalf'}->username	= '';
	$olustur->{'3dooshalf'}->password	= '';
	echo serialize($olustur);
 */

class garanti_3dooshalf
{
	public $ci;
	protected $banka = 'garanti';
	protected $ascii = '3dooshalf';
	...
	{
		log_message('debug', 'garanti_3dooshalf Library Yüklendi');
	...
	function form_gonder($gelen_veriler = null)
	{
		if(!is_null($gelen_veriler) AND $banka_bilgi = $this->banka_bilgi())
		{
			...
			$form .= form_hidden('secure3dsecuritylevel', '3D_OOS_HALF');
