...
$this->load->view('yonetim/header_view');  
	...
	$kargo_adi = array(
		...
		'id' 	=> 'kargo_adi',
		'class' => 'text',
		'value' => (($val->kargo_adi)) ? $val->kargo_adi:NULL,
		'size' => '50'
	);
	$ucret_tip1 = array(
		'name' 	=> 'ucret_tip1',
		'id' 	=> 'ucret_tip1',
		'class' => 'text',
		'value' => (($val->ucret_tip1)) ? $val->ucret_tip1:NULL,
		'size' => '50'
	);
	$ucret_tip2 = array(
		'name' 	=> 'ucret_tip2',
		'id' 	=> 'ucret_tip2',
		'class' => 'text',
		'value' => (($val->ucret_tip2)) ? $val->ucret_tip2:NULL,
		'size' => '50'
	);
	$ucret_tip3 = array(
		'name' 	=> 'ucret_tip3',
		'id' 	=> 'ucret_tip3',
		'class' => 'text',
		'value' => (($val->ucret_tip3)) ? $val->ucret_tip3:NULL,
		'size' => '50'
	);
	$ucret_tip4 = array(
		'name' 	=> 'ucret_tip4',
		'id' 	=> 'ucret_tip4',
		'class' => 'text',
		'value' => (($val->ucret_tip4)) ? $val->ucret_tip4:NULL,
		'size' => '50'
	);
	$ucret_tip5 = array(
		'name' 	=> 'ucret_tip5',
		'id' 	=> 'ucret_tip5',
		'class' => 'text',
		'value' => (($val->ucret_tip5)) ? $val->ucret_tip5:NULL,
		'size' => '50'
	);
	$ucret_tip6 = array(
		'name' 	=> 'ucret_tip6',
		'id' 	=> 'ucret_tip6',
		'class' => 'text',
		'value' => (($val->ucret_tip6)) ? $val->ucret_tip6:NULL,
		'size' => '50'
	);
	$ucret_tip7 = array(
		'name' 	=> 'ucret_tip7',
		'id' 	=> 'ucret_tip7',
		'class' => 'text',
		'value' => (($val->ucret_tip7)) ? $val->ucret_tip7:NULL,
		'size' => '50'
	);
	$ucret_tip8 = array(
		'name' 	=> 'ucret_tip8',
		'id' 	=> 'ucret_tip8',
		'class' => 'text',
		'value' => (($val->ucret_tip8)) ? $val->ucret_tip8:NULL,
		'size' => '50'
	);
...
<div class="box">
	...
	<div class="content">
    	...
    	<form action="<?php echo yonetim_url('sistem/kargo/ekle'); ?>" method="post" enctype="multipart/form-data" id="form">
		<div id="tab_general">
			<table class="form">
		        <tr>
				...
				<tr>
					...
					<td>
						<?php
							...
							{
								$preview = $this->image_model->resize($this->input->post('product_images'), 100, 100);
							} else {
								$preview = $this->image_model->resize('no_image.jpg', 100, 100);
							}
						?>
						<input type="hidden" name="product_image" value="<?php echo ($val->product_image) ? $val->product_image : $preview; ?>" id="product_image" />
			           	 <img src="<?php echo ($val->product_image) ? $val->product_image : $preview; ?>" alt="aa" id="preview" class="image" onclick="image_upload('product_image', 'preview');" />
					</td>
				</tr>
				<tr>
					<td>Durum:</td>
