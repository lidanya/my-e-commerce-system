...
<div class="box">
  ...
  <div class="content">
    <form action="<?php echo yonetim_url('uye_yonetimi/yonetici_grup/ekle'); ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
        <tr>
        ...
        <tr>
          ...
          <td>
			<?php
				...
				{
					echo '<div style="margin:5px;"><input type="checkbox" name="yetki['. $sayfa_url .'][izin]" value="1" /> ' . $sayfa_adi . ' </div>' . "\n";
				}
			?>
