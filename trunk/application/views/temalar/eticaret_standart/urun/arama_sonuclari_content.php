...
<div id="orta" class="sola">
	...
	<!-- FILTRE BAŞLADI  -->
	<form action="<?php echo site_url('urun/arama/index') ?>" method="get" id="filtre" accept-charset="utf-8">
...
<?php } else { ?>
	...
	<h1 id="sayfa_baslik"><?php echo lang('messages_product_search_title'); ?></h1>
	<div id="sonuc_yok">
		<div class="sola" style="margin-left:30px;"><img src="<?php echo site_resim();?>unlem.png" alt="dikkat" title="Sonuç Bulunamadı"></div>
		<ul  class="sola">
			<?php
