...
<!-- Kayit Oldum -->
	...
	<div style="margin-left:35px;font-weight:bold;font-size:14px !important;color:#ff6400 !important; !important;">
		Sn <b style="color:#008fff !important;font-size:18px !important;"><?php echo $adsoyad ;?></b> Bizi Tercih Ettiğiniz İçin Teşekkür Ederiz
	</div>
	<br />
	<div style="margin-left:35px;font-size:13px; color:#414141 !important; !important;line-height:20px;">
		Şifreniz başarı ile değiştirilmiştir. Yeni bilgileriniz aşağıdaki gibidir:
	</div>
	<br />
	<div style="width:150px;font-size:13px;text-align:right;float:left;font-weight:bold;color:#414141 !important;">
		Kullanıcı Mailiniz:
	</div>
	<div style="font-size:13px;text-align:right;float:left;margin-left:10px;color:#ff6400 !important;">
		<?php echo $email ;?>
	</div>
