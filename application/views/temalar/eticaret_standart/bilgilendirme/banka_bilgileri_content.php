	...
	<div id="bs_container">
		...
		<div class="page_ic">
			...
			if($havale_sorgu->num_rows() > 0)
			{
				...
				{
					$banka_logo = ($i == 1) ? '<img src="' . site_resim() . $havaleler->havale_banka_resim . '" alt="'. $havaleler->havale_banka_baslik .'">':'&nbsp;';
					...
					echo '<span class="bb_tablo01 sola">'. '<img src="' . site_resim() . $havaleler->havale_banka_resim . '" alt="'. $havaleler->havale_banka_baslik .'">' .'</span>' . "\n";
