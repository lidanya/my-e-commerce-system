		...
		this.each(function() {
			...
			if(options.controlsShow){
				...
				if(options.numeric){
					...
					html += ' <li class="'+ options.prevClass +'" id="'+ options.prevId +'"><a href=\"javascript:void(0);\">'+ options.prevText +'</a></li>';
					html += ' <li class="'+ options.nextClass +'" id="'+ options.nextId +'"><a href=\"javascript:void(0);\">'+ options.nextText +'</a></li>';
