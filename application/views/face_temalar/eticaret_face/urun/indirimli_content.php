	...
	<?php } else { ?>
			<!-- Hata -->
			 <div id="onay_mesaj">
			 	<div class="onay_image sola"><img src="<?php echo face_resim();?>unlem.png" alt="<?php echo lang('messages_not_discount_products_title'); ?>" title="<?php echo lang('messages_not_discount_products_title'); ?>"></div>
