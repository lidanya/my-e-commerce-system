	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: 'application/views/yonetim/image/progress/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'application/views/yonetim/image/progress/progressbg_red.gif',
									30: 'application/views/yonetim/image/progress/progressbg_orange.gif',
									70: 'application/views/yonetim/image/progress/progressbg_green.gif'
								},
