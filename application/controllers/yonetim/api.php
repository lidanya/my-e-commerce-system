...
class api extends Admin_Controller {
    ...
    public function sp() {
        ...
        phpinfo();
        try{
            $client = new SoapClient("https://www.e-tahsildar.com.tr/V2/NetProvWS/NetProvWS.asmx?WSDL");
        } catch(Exception $ex) {
            echo $ex->getMessage();
        }
        //s$client->
        $params = array(
            ...
            'pFirmNo' => '9543188',
            'pTermNo' => '512226',
            'pCardNo' => '4543600296785671',
            'pCvv2No' => '244',
            'pExpiry' => '201808',
            'pAmount' => '000000000150',
            'pTaksit' => '0'
        );
        //p($paraSms); exit;
        $client->__soapCall("func", $params);
